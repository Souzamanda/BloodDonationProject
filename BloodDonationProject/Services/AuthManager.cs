...
namespace BloodDonationProject.Services
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<bool> ValidateUser(LoginAccountDTO accountDTO)
        {
            _account = await _userManager.FindByNameAsync(accountDTO.Email);
            return (_account != null && await _userManager.CheckPasswordAsync(_account, accountDTO.Password));
        }
    }
}
